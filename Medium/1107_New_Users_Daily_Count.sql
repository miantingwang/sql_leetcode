...
-- find out each user's first login date
-- count the activity of a user if the date matches their first login date
-- first login date should be within 90 days from 2019-06-30
...
GROUP BY login_date
-- HAVING login_date BETWEEN ('2019-06-30' - INTERVAL 90 DAY) AND '2019-06-30';
