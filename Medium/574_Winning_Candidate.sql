...
-- group by the candidateId from the vote table to count the vote
-- join the candidate table with the vote table to get the name of the candidate's name
-- pick the candidate name that has the most votes
